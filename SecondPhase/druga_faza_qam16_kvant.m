...
qam16_rx_I_filt = filter(hrrc_k,1,qam16_rx_I_c);
qam16_rx_Q_filt = filter(hrrc_k,1,qam16_rx_Q_c);
...
title('Konstelacioni dijagram 16-QAM sa kvantizovanim RRC filtrom');
xlabel('I');
ylabel('Q');
